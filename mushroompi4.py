...
#  
# 
# Uses a PWB channel to control a beeper to make the sound
...
def main(args):
	...
	pwm = GPIO.PWM(18, 1) # frequency = 1 Hz
    ...
    while True:
		...
		modulationf=prob*5
		# Make the changes to the PWM frequency
		pwm.ChangeFrequency(modulationf)
